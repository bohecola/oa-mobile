<template>
  <van-form ref="Form" v-loading="isLoading && showLoading" readonly label-width="auto">
    <van-cell-group inset class="!my-3">
      <van-field v-show-field="['employmentId', includeFields]" name="employmentId" label="员工" input-align="right">
        <template #input>
      ...
      <!-- <van-field v-show-field="['employmentEvaluate', includeFields]" name="employmentEvaluate" label="面试评价" input-align="right">
      <template #input>
