...
export function useForm() {
  ...
  const initFormData: DeptForm = {
    ...
    phone: undefined,
    email: undefined,
    specialCommercialInsurance: 'N', // 购买特殊商业保险
    insuranceLimit: 0,
    status: undefined,
    redFile: undefined,
    ossIdList: undefined,
  ...
  const data = reactive<Omit<PageData<DeptForm, object>, 'queryParams'>>({
    ...
    rules: {
      ...
      specialCommercialInsurance: [{ required: true, message: '购买特殊商业保险不能为空', trigger: 'onChange' }],
      insuranceLimit: [{ required: true, message: '保险额度不能为空', trigger: 'onBlur' }],
