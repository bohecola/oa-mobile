...
// 人力资源确认
const humanResourcesDetail1 = ref<InstanceType<typeof detail>>()
const humanResourcesUpsert = ref<InstanceType<typeof upsert>>()
const humanResourcesDetail2 = ref<InstanceType<typeof detail>>()
