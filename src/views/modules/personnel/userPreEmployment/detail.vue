<template>
  <van-form ref="Form" v-loading="isLoading && showLoading" readonly label-width="10em">
    <van-cell-group inset class="!my-3">
      ...
      <van-field v-if="!isNil(form.certificates) && form.certificates.includes('其他证书')" v-model="form.otherCertificates" v-show-field="['otherCertificates', includeFields]" name="otherCertificates" label="其他证书" input-align="right">
        <template #input>
