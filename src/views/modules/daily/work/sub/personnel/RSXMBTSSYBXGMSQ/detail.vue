<template>
  <van-field v-show-field="['qq_deptId', includeFields]" label="部门/项目部" name="qq_deptId" input-align="right">
    <template #input>
  ...
  <van-field v-show-field="['qq_isHighVoltageOperation', includeFields]" label="是否涉及高压电作业" name="qq_isHighVoltageOperation" input-align="right">
    <template #input>
      <YesNoSwitch v-model="form.qq_isHighVoltageOperation" readonly />
    </template>
  </van-field>

  <van-field v-show-field="['qq_isClimbingHomework', includeFields]" label="是否涉及登高作业" name="qq_isClimbingHomework" input-align="right">
    <template #input>
      <YesNoSwitch v-model="form.qq_isClimbingHomework" readonly />
    </template>
  </van-field>

  <van-field v-if="form.qq_isClimbingHomework === 'Y'" v-model="form.qq_distanceRange" v-show-field="['qq_distanceRange', includeFields]" label="登高作业位置到地面的距离范围(米)" name="qq_distanceRange" input-align="right" />

  <van-field v-show-field="['qq_isNewHiredPurchaseInsurance', includeFields]" label="该项目部新入职人员是否购买此类保险" name="qq_isNewHiredPurchaseInsurance" input-align="right">
    <template #input>
      <YesNoSwitch v-model="form.qq_isNewHiredPurchaseInsurance" readonly />
    </template>
  </van-field>
  <van-field v-show-field="['qq_transferInDeptPurchaseInsurance', includeFields]" label="调入该项目部是否购买此类保险" name="qq_transferInDeptPurchaseInsurance" input-align="right">
    <template #input>
      <YesNoSwitch v-model="form.qq_transferInDeptPurchaseInsurance" readonly />
    </template>
  </van-field>
  <van-field v-show-field="['qq_transferOutDeptNoPurchaseInsurance', includeFields]" label="调出该项目部是否取消购买此类保险" name="qq_transferOutDeptNoPurchaseInsurance" input-align="right">
    <template #input>
      <YesNoSwitch v-model="form.qq_transferOutDeptNoPurchaseInsurance" readonly />
    </template>
  </van-field>

  <van-field v-show-field="['qq_isEarlyStagePurchaseInsurance', includeFields]" label="该项目部前期是否已购买其他商业类保险" name="qq_isEarlyStagePurchaseInsurance" input-align="right">
    <template #input>
      <YesNoSwitch v-model="form.qq_isEarlyStagePurchaseInsurance" readonly />
    </template>
  </van-field>

  <van-field v-if="form.qq_isEarlyStagePurchaseInsurance === 'Y'" v-show-field="['qq_isOldInsuranceTermination', includeFields]" label="原特殊商业保险是否终止" name="qq_isOldInsuranceTermination" input-align="right">
    <template #input>
      <YesNoSwitch v-model="form.qq_isOldInsuranceTermination" readonly />
    </template>
  </van-field>

  <van-field v-if="form.qq_isOldInsuranceTermination === 'Y'" v-model="form.qq_isOldInsuranceTerminationReason" v-show-field="['qq_isOldInsuranceTerminationReason', includeFields]" label="原特殊商业保险终止原因说明" name="qq_isOldInsuranceTerminationReason" input-align="right">
    <template #input>
      <TextareaView :value="form.qq_isOldInsuranceTerminationReason" />
    </template>
  </van-field>

  <van-field v-show-field="['qq_isBelong', includeFields]" label="人员是否属于该项目部" name="qq_isBelong" input-align="right">
    <template #input>
      <YesNoSwitch v-model="form.qq_isBelong" readonly />
    </template>
  </van-field>

  <van-field v-if="form.qq_isBelong === 'N'" v-model="form.qq_notBelongDeptPurchaseInsuranceSpecialReason" v-show-field="['qq_notBelongDeptPurchaseInsuranceSpecialReason', includeFields]" label="不属于该项目部人员购买保险原因" name="qq_notBelongDeptPurchaseInsuranceSpecialReason" input-align="right">
    <template #input>
