<template>
  ...
  <van-field v-if="form.q_type?.includes('0')" v-show-field="['q_defectEliminationAmount', includeFields]" label="技术消缺总金额（元）" name="q_defectEliminationAmount" input-align="left">
    <template #input>
  ...
  <van-field v-if="form.q_type?.includes('1')" v-show-field="['q_trafficAmount', includeFields]" label="项目交通费（元）" name="q_trafficAmount" input-align="left">
    <template #input>
  ...
  <van-field v-if="form.q_type?.includes('2')" v-show-field="['q_personnelReuseSubsidyAmount', includeFields]" label="人员复用补贴总金额（元）" name="q_personnelReuseSubsidyAmount" input-align="left">
    <template #input>
  ...
  <van-field v-if="!isNil(form.q_type)" v-show-field="['q_totalAmount', includeFields]" label="合计金额（元）" name="q_totalAmount" input-align="left">
    <template #input>
      {{ form.q_totalAmount }}
