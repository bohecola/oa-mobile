<template>
  <van-field v-show-field="['d_deptId', includeFields]" label="部门/项目部" name="d_deptId" input-align="left">
    <template #input>
      <DeptSelect v-model="form.d_deptId" clearable />
    </template>
  </van-field>

  <van-field v-show-field="['d_proveType', includeFields]" label="证明类别" name="d_proveType" input-align="left">
    <template #input>
