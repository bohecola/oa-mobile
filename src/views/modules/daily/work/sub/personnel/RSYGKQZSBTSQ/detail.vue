<template>
  ...
  <van-field v-model="form.yy_name" v-show-field="['yy_name', includeFields]" label="证书名称" name="yy_name" input-align="right" />

  <van-field v-show-field="['yy_certificateStatus', includeFields]" label="证书状态" name="yy_certificateStatus" input-align="right">
    <template #input>
      <DictSelect v-model="form.yy_certificateStatus" dict-type="sys_normal_disable" readonly />
    </template>
  </van-field>

  <van-field v-model="form.yy_speciality" v-show-field="['yy_speciality', includeFields]" label="专业名称" name="yy_speciality" input-align="right" />

  <van-field v-model="form.yy_no" v-show-field="['yy_no', includeFields]" label="编号" name="yy_no" input-align="right" />
  ...
  <van-field v-model="form.yy_unit" v-show-field="['yy_unit', includeFields]" label="工作/申报单位" name="yy_unit" input-align="right" />
