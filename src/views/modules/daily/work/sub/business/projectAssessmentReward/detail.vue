<template>
  <van-field v-show-field="['a_contractId', includeFields]" label="合同名称" name="a_contractId" input-align="right">
    <template #input>
      <ContractSelect v-model="form.a_contractId" :params="{ type: 'in' }" readonly />
    </template>
  </van-field>

  <van-field v-show-field="['a_businessType', includeFields]" label="项目类别" name="a_businessType" input-align="right">
    <template #input>
      <DictSelect v-model="form.a_businessType" dict-type="oa_project_business_type" readonly />
    </template>
  </van-field>

  <van-field v-show-field="['a_deptId', includeFields]" label="部门" name="a_deptId" input-align="right">
    <template #input>
      <DeptSelect v-model="form.a_deptId" readonly />
    </template>
  </van-field>

  <van-field v-show-field="['a_contractNo', includeFields]" label="合同编号" name="a_contractNo" input-align="right">
    <template #input>
      {{ form.a_contractNo }}
    </template>
  </van-field>

  <van-field v-show-field="['a_partyA', includeFields]" label="甲方名称" name="a_partyA" input-align="right">
    <template #input>
  ...
  <van-field v-show-field="['a_rewardAmount', includeFields]" label="奖励金额（元）" name="a_rewardAmount" input-align="right">
    <template #input>
