<template>
  ...
  <van-field v-model="form.ll_letterType" v-show-field="['ll_letterType', includeFields]" label="函件类型" name="ll_letterType" input-align="left" />

  <van-field v-model="form.ll_fileType" v-show-field="['ll_fileType', includeFields]" label="文件类型" name="ll_fileType" input-align="left" />
