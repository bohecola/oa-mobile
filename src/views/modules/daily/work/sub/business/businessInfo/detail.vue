<template>
  ...
  <van-field v-model="form.kk_applicationMaterials" v-show-field="['kk_applicationMaterials', includeFields]" label="申请资料" name="kk_applicationMaterials" input-align="right" />
