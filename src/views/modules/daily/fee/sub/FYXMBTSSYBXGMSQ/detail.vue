<template>
  ...
  <van-field v-model="form.e_purchaseInsuranceNumber" v-show-field="['e_purchaseInsuranceNumber', includeFields]" label="购买保险人数" name="e_purchaseInsuranceNumber" input-align="left" />
  ...
  <van-field v-if="form.e_isOldInsuranceTermination === 'Y'" v-model="form.e_isOldInsuranceTerminationReason" v-show-field="['e_isOldInsuranceTerminationReason', includeFields]" label="原特殊商业保险终止原因说明" name="e_isOldInsuranceTerminationReason" input-align="left">
    <template #input>
  ...
  <van-field v-if="form.e_isBelong === 'N'" v-model="form.e_notBelongDeptPurchaseInsuranceSpecialReason" v-show-field="['e_notBelongDeptPurchaseInsuranceSpecialReason', includeFields]" label="不属于该项目部人员购买保险原因" name="e_notBelongDeptPurchaseInsuranceSpecialReason" input-align="left">
    <template #input>
      <TextareaView :value="form.e_notBelongDeptPurchaseInsuranceSpecialReason" />
    </template>
  </van-field>

  <van-field v-model="form.e_insurancePeriod" v-show-field="['e_insurancePeriod', includeFields]" label="保险期限" name="e_insurancePeriod" input-align="left" />

  <van-field v-show-field="['e_purchaseInsuranceReason', includeFields]" label="购买保险原因" name="e_purchaseInsuranceReason" input-align="left">
    <template #input>
      <TextareaView :value="form.e_purchaseInsuranceReason" />
    </template>
  </van-field>

  <van-field v-model="form.e_purchaseInsuranceSpecialExplain" v-show-field="['e_purchaseInsuranceSpecialExplain', includeFields]" label="保险购买特殊说明" name="e_purchaseInsuranceSpecialExplain" input-align="left">
    <template #input>
