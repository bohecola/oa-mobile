...
const extraInitFormData: DailyFeeForm = {
  ...
  b_lastAnnualReviewExpirationDate: undefined,
  b_lastVerificationDate: undefined,
  ...
  b_insuranceCompany: undefined,
  b_compulsoryInsuranceDate: undefined,
  b_compulsoryInsuranceExpirationDate: undefined,
  b_commercialInsuranceDate: undefined,
  b_commercialInsuranceExpirationDate: undefined,
  b_upMileage: undefined,
...
const extraInitRules: Record<string, FieldRule[]> = {
  ...
  b_lastRepairDate: [{ required: false, message: `上次维修日期${baseMsg}`, trigger: 'onBlur' }],
  ...
  b_lastStrongInsuranceExpirationDate: [{ required: false, message: `上期交强险到期日期${baseMsg}`, trigger: 'onBlur' }],
  b_lastCommercialInsuranceExpirationDate: [{ required: false, message: `上期商业险到期日期${baseMsg}`, trigger: 'onBlur' }],
  ...
  b_totalAmount: [{ required: false, message: `总计金额${baseMsg}`, trigger: 'onBlur' }],
  b_insuranceCompany: [{ required: true, message: `保险公司${baseMsg}`, trigger: 'onBlur' }],
  b_compulsoryInsuranceDate: [{ required: true, message: `交强险购买日期${baseMsg}`, trigger: 'onBlur' }],
  b_compulsoryInsuranceExpirationDate: [{ required: true, message: `交强险到期日期${baseMsg}`, trigger: 'onBlur' }],
  b_commercialInsuranceDate: [{ required: true, message: `商业险购买日期${baseMsg}`, trigger: 'onBlur' }],
  b_commercialInsuranceExpirationDate: [{ required: true, message: `商业险到期日期${baseMsg}`, trigger: 'onBlur' }],
